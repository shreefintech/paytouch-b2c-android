...
class DthPlanAdp(
    ...
    private val mArrayList: ArrayList<DthPlanItem>
) : RecyclerView.Adapter<DthPlanAdp.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            ...
            if (pos != RecyclerView.NO_POSITION) onClickItem?.invoke(mArrayList[pos])
        }
    }

    fun updateList(items: List<DthPlanItem>) {
        mArrayList.clear()
