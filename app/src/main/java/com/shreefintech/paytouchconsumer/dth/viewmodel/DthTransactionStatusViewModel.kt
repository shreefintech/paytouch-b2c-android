...
class DthTransactionStatusViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun loadStatus(
        ...
        isLoading = true
        onLoading()
        ApiClient.apiService.getDthTransactionStatus(
            bearerToken(),
            DthTransactionStatusRequest(subscriberNo = null, transactionId = query, page = page, perPage = PER_PAGE)
