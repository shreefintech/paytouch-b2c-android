...
import com.shreefintech.paytouchconsumer.databinding.ActivityDthRecentTransactionBinding
import com.shreefintech.paytouchconsumer.dth.viewmodel.DthRecentTransactionViewModel
import com.shreefintech.paytouchconsumer.glass.LiquidGlassEffect
import com.shreefintech.paytouchconsumer.utill.ToastUtil
import com.shreefintech.paytouchconsumer.utill.Utility

class DthRecentTransactionActivity : BaseActivity() {

    companion object {
        fun start(context: Context) {
            context.startActivity(Intent(context, DthRecentTransactionActivity::class.java))
        }
    }

    private lateinit var binding: ActivityDthRecentTransactionBinding
    private lateinit var recentTransactionAdp: RecentTransactionAdp
    private val viewModel: DthRecentTransactionViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDthRecentTransactionBinding.inflate(layoutInflater)
