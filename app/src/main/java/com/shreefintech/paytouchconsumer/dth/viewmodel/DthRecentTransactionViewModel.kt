...
class DthRecentTransactionViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun fetchTransactions(
        ...
        ApiClient.apiService.getTransactions(bearerToken(), "dth", currentPage, PAGE_SIZE)
    ...
    private fun mapToDisplayItem(item: UnifiedTransactionItem): RecentTransactionItem {
        ...
        val service = when {
            ...
            else -> getString(R.string.categoryDth)
        }
