...
import com.shreefintech.paytouchconsumer.databinding.ActivityDthTransactionStatusBinding
import com.shreefintech.paytouchconsumer.dth.viewmodel.DthTransactionStatusViewModel
...
class DthTransactionStatusActivity : BaseActivity() {

    private lateinit var binding: ActivityDthTransactionStatusBinding
    private val viewModel: DthTransactionStatusViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDthTransactionStatusBinding.inflate(layoutInflater)
