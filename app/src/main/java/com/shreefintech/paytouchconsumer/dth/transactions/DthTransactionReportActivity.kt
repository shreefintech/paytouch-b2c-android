...
import com.shreefintech.paytouchconsumer.databinding.ActivityDthTransactionReportBinding
import com.shreefintech.paytouchconsumer.dth.viewmodel.DthTransactionReportViewModel
...
class DthTransactionReportActivity : BaseActivity() {

    private lateinit var binding: ActivityDthTransactionReportBinding
    private val viewModel: DthTransactionReportViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDthTransactionReportBinding.inflate(layoutInflater)
