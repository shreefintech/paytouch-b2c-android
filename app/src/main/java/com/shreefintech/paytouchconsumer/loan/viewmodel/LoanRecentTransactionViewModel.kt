...
class LoanRecentTransactionViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun fetchTransactions(
        ...
        ApiClient.apiService.getTransactions(bearerToken(), "loan_repayment", currentPage, PAGE_SIZE)
    ...
    private fun mapToDisplayItem(item: UnifiedTransactionItem): RecentTransactionItem {
        ...
        val service = when {
            ...
            else -> getString(R.string.categoryLoan)
        }
