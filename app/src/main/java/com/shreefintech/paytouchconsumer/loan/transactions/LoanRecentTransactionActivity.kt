...
import com.shreefintech.paytouchconsumer.databinding.ActivityLoanRecentTransactionBinding
import com.shreefintech.paytouchconsumer.glass.LiquidGlassEffect
import com.shreefintech.paytouchconsumer.loan.viewmodel.LoanRecentTransactionViewModel
import com.shreefintech.paytouchconsumer.utill.ToastUtil
import com.shreefintech.paytouchconsumer.utill.Utility

class LoanRecentTransactionActivity : BaseActivity() {

    companion object {
        fun start(context: Context) {
            context.startActivity(Intent(context, LoanRecentTransactionActivity::class.java))
        }
    }

    private lateinit var binding: ActivityLoanRecentTransactionBinding
    private lateinit var recentTransactionAdp: RecentTransactionAdp
    private val viewModel: LoanRecentTransactionViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLoanRecentTransactionBinding.inflate(layoutInflater)
