...
class LoanTransactionReportActivity : BaseActivity() {

    private lateinit var binding: ActivityLoanTransactionReportBinding
    private val viewModel: LoanTransactionReportViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLoanTransactionReportBinding.inflate(layoutInflater)
