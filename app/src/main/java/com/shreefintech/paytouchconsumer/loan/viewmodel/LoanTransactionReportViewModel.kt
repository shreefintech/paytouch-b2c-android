...
class LoanTransactionReportViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun loadReport(
        ...
        isLoading = true
        onLoading()
        ApiClient.apiService.getLoanPaymentReport(
            bearerToken(),
            LoanTransactionReportRequest(fromDate, toDate, status, consumerNo, page, PER_PAGE)
