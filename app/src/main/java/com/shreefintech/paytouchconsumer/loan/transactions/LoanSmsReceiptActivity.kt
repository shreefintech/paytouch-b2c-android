...
import com.shreefintech.paytouchconsumer.databinding.ActivityLoanSmsReceiptBinding
import com.shreefintech.paytouchconsumer.glass.LiquidGlassEffect
import com.shreefintech.paytouchconsumer.loan.viewmodel.LoanSmsReceiptViewModel
...
class LoanSmsReceiptActivity : BaseActivity() {

    private lateinit var binding: ActivityLoanSmsReceiptBinding
    private val showProgressReceipt = ObservableBoolean(false)

    private val viewModel: LoanSmsReceiptViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLoanSmsReceiptBinding.inflate(layoutInflater)
