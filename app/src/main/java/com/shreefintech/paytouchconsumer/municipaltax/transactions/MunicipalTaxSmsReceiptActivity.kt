...
import com.shreefintech.paytouchconsumer.databinding.ActivityMunicipalTaxSmsReceiptBinding
import com.shreefintech.paytouchconsumer.glass.LiquidGlassEffect
import com.shreefintech.paytouchconsumer.municipaltax.viewmodel.MunicipalTaxSmsReceiptViewModel
...
class MunicipalTaxSmsReceiptActivity : BaseActivity() {

    private lateinit var binding: ActivityMunicipalTaxSmsReceiptBinding
    private val showProgressReceipt = ObservableBoolean(false)
    private val viewModel: MunicipalTaxSmsReceiptViewModel by viewModels()
    ...
    companion object {
        ...
        fun start(context: Context, fromPayment: Boolean = false) {
            context.startActivity(
                Intent(context, MunicipalTaxSmsReceiptActivity::class.java).apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMunicipalTaxSmsReceiptBinding.inflate(layoutInflater)
    ...
    private fun populateReceiptFromDetail(item: TransactionHistoryDetailItem) {
        ...
        val smsBodyText = getString(R.string.msgMunicipalTaxSmsBody, amount, identifier)
        val spannable   = SpannableString(smsBodyText)
        val amountStart = smsBodyText.indexOf(amount)
        if (amountStart >= 0) {
            val amountEnd = amountStart + amount.length
