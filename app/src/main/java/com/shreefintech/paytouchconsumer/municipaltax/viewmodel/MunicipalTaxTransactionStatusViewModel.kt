...
class MunicipalTaxTransactionStatusViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun loadStatus(
        ...
        isLoading = true
        onLoading()
        ApiClient.apiService.getMunicipalTaxTransactionStatus(
            bearerToken(),
            MunicipalTaxTransactionStatusRequest(transactionId = query, page = page, perPage = PER_PAGE)
