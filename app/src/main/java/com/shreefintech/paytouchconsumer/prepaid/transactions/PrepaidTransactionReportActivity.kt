...
import com.shreefintech.paytouchconsumer.databinding.ActivityPrepaidTransactionReportBinding
import com.shreefintech.paytouchconsumer.glass.LiquidGlassEffect
import com.shreefintech.paytouchconsumer.prepaid.viewmodel.PrepaidTransactionReportViewModel
...
class PrepaidTransactionReportActivity : BaseActivity() {

    private lateinit var binding: ActivityPrepaidTransactionReportBinding
    private val viewModel: PrepaidTransactionReportViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPrepaidTransactionReportBinding.inflate(layoutInflater)
