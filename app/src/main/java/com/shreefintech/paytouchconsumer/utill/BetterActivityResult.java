...
public class BetterActivityResult<Input, Result> {
    ...
    public void launch(Input input, ActivityOptionsCompat activityOptions, @Nullable OnActivityResult<Result> onActivityResult) {
        if (onActivityResult != null) {
            this.onActivityResult = onActivityResult;
        }
        launcher.launch(input, activityOptions);
    }
...
betterActivityResult =
            BetterActivityResult.registerActivityForResult(this as ActivityResultCaller)
            */