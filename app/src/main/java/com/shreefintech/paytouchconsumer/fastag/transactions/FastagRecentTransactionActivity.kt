...
import com.shreefintech.paytouchconsumer.databinding.ActivityFastagRecentTransactionBinding
import com.shreefintech.paytouchconsumer.fastag.viewmodel.FastagRecentTransactionViewModel
import com.shreefintech.paytouchconsumer.glass.LiquidGlassEffect
import com.shreefintech.paytouchconsumer.utill.ToastUtil
import com.shreefintech.paytouchconsumer.utill.Utility

class FastagRecentTransactionActivity : BaseActivity() {

    companion object {
        fun start(context: Context) {
            context.startActivity(Intent(context, FastagRecentTransactionActivity::class.java))
        }
    }

    private lateinit var binding: ActivityFastagRecentTransactionBinding
    private lateinit var recentTransactionAdp: RecentTransactionAdp
    private val viewModel: FastagRecentTransactionViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFastagRecentTransactionBinding.inflate(layoutInflater)
