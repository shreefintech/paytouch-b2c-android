...
class FastagRecentTransactionViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun fetchTransactions(
        ...
        ApiClient.apiService.getTransactions(bearerToken(), "fastag", currentPage, PAGE_SIZE)
