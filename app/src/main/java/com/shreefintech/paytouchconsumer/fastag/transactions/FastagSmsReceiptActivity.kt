...
import com.shreefintech.paytouchconsumer.databinding.ActivityFastagSmsReceiptBinding
import com.shreefintech.paytouchconsumer.fastag.viewmodel.FastagSmsReceiptViewModel
...
class FastagSmsReceiptActivity : BaseActivity() {

    private lateinit var binding: ActivityFastagSmsReceiptBinding
    private val showProgressReceipt = ObservableBoolean(false)

    private val viewModel: FastagSmsReceiptViewModel by viewModels()
    ...
    companion object {
        ...
        fun start(context: Context, fromPayment: Boolean = false) {
            context.startActivity(
                Intent(context, FastagSmsReceiptActivity::class.java).apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFastagSmsReceiptBinding.inflate(layoutInflater)
    ...
    private fun populateReceiptFromApi(item: FastagLatestPaymentDataItem) {
        ...
        binding.tvConsumerNo.text      = vehicleNo
        binding.tvCustomerName.text    = "--"
        binding.tvCompanyName.text     = item.operatorName?.takeIf { it.isNotEmpty() } ?: item.operator ?: "--"
        ...
        val smsBodyText = getString(R.string.msgFastagSmsBody, amount, vehicleNo)
