...
class FastagTransactionReportActivity : BaseActivity() {

    private lateinit var binding: ActivityFastagTransactionReportBinding
    private val viewModel: FastagTransactionReportViewModel by viewModels()
    ...
    private var filterVehicleNo:   String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFastagTransactionReportBinding.inflate(layoutInflater)
    ...
    private fun callReport(fromDate: String?, toDate: String?, status: String?, vehicleNo: String?) {
        filterFromDate  = fromDate
        filterToDate    = toDate
        filterStatus    = status
        filterVehicleNo = vehicleNo
        loadPage(1)
    }
