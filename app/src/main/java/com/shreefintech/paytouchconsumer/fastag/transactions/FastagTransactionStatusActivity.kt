...
import com.shreefintech.paytouchconsumer.databinding.ActivityFastagTransactionStatusBinding
import com.shreefintech.paytouchconsumer.fastag.viewmodel.FastagTransactionStatusViewModel
...
class FastagTransactionStatusActivity : BaseActivity() {

    private lateinit var binding: ActivityFastagTransactionStatusBinding
    private val viewModel: FastagTransactionStatusViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFastagTransactionStatusBinding.inflate(layoutInflater)
