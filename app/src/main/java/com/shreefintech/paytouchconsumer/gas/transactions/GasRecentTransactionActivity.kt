...
import com.shreefintech.paytouchconsumer.databinding.ActivityGasRecentTransactionBinding
import com.shreefintech.paytouchconsumer.gas.viewmodel.GasRecentTransactionViewModel
import com.shreefintech.paytouchconsumer.glass.LiquidGlassEffect
import com.shreefintech.paytouchconsumer.utill.ToastUtil
import com.shreefintech.paytouchconsumer.utill.Utility

class GasRecentTransactionActivity : BaseActivity() {

    private lateinit var binding: ActivityGasRecentTransactionBinding
    private lateinit var recentTransactionAdp: RecentTransactionAdp
    private val viewModel: GasRecentTransactionViewModel by viewModels()

    companion object {
        fun start(context: Context) {
            context.startActivity(Intent(context, GasRecentTransactionActivity::class.java))
        }
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGasRecentTransactionBinding.inflate(layoutInflater)
